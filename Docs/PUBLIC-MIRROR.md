...
- `scripts/build-*.ps1` â€” build scripts a self-hoster needs to compile their
...
- `Docs/rollyourown.md` â€” open-core strategy doc; public-facing already.
- `Docs/PUBLIC-MIRROR.md` â€” this file. The public mirror documents its own
  origin honestly.
