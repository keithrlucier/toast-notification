...
> **ARCHIVED 2026-06-03** by the fresh cold pass that followed it (post-v0.4.38 remediation).
> This is the closed record of the v0.4.37 cold review (RMM-H1/H2, Agent-M1, Wix-M1, RMM-M1/M2)
> and its 2026-06-03 remediation pass. Superseded by the root `REVIEW_LEDGER.md`.
