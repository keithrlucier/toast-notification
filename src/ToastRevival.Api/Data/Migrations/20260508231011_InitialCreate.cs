        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModerationResultJson = table.Column<string>(type: "text", nullable: true),
                    UploadedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    UploadedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssetLibrary", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssetLibrary_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyLine1Template = table.Column<string>(type: "text", nullable: true),
                    BodyLine2Template = table.Column<string>(type: "text", nullable: true),
                    HeroImageId = table.Column<Guid>(type: "uuid", nullable: true),
                    LogoImageId = table.Column<Guid>(type: "uuid", nullable: true),
                    ActionButtonsJson = table.Column<string>(type: "text", nullable: true),
                    AudioSetting = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyLine1 = table.Column<string>(type: "text", nullable: true),
                    BodyLine2 = table.Column<string>(type: "text", nullable: true),
                    ...
                    TargetIdsJson = table.Column<string>(type: "text", nullable: true),
                    TargetDeviceCount = table.Column<int>(type: "integer", nullable: false),
                    ModerationResultJson = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InteractedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationDeliveries_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_RegistrationToken",
                table: "Devices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationDeliveries_NotificationId_DeviceId",
                table: "NotificationDeliveries",
